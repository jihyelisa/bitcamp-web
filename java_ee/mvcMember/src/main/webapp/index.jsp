...
<% if (session.getAttribute("memId") == null) { %>
	<a href="./member/writeForm.do">회원가입</a><br><br>
	<a href="./member/loginForm.do">로그인</a><br><br>
	
<% } else { %>
	<a href="./member/logout.do">로그아웃</a><br><br>
	<a href="./member/updateForm.do">회원정보수정</a><br><br>
